...
namespace Dart
{
    ...
    public class MainWindowViewModel : ViewModelBase, IMainWindowViewModel, ICloneable
    {
        ...
        [Export(typeof(Environment.IProperties))]
        public Environment.IProperties CurrentProperties { get; private set; }
        ...
        private void LoadPlugIns()
        {
            try
            {
                ...
                CurrentProperties = new Environment.Properties(SettingsViewModel.CurrentApplicationSettings.CurrentTheme.OriginalTheme.Name, SettingsViewModel.CurrentApplicationSettings.SelectedCultureInfo);
